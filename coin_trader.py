...
def run_for_n_days(num_days, threshold_to_sell, print_short_stats=True, print_full_stats=False):
    ...
    if print_full_stats:
        ...
        print("Ending current_free_balance: %d" % current_free_balance)
        print("Ending current_number_of_coins: %d" % current_number_of_coins)
        print("Ending value of current_number_of_coins: %d" % (current_number_of_coins * last_historical_price))
        print("Ending total in coin OR cash: %d" % total_portfolio_value)
